...
var discordInvite = document.createElement('div');
discordInvite.innerHTML = '<a href="https://discord.gg/8uy6Fm6S">Join the Discord</a>';
document.body.appendChild(discordInvite);
});
        </script>
    </head>
    <body style="margin: 0;">
